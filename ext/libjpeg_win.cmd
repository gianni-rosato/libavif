...
#
#     WITH_CRT_DLL
cmake -S libjpeg-turbo -B libjpeg-turbo/build.libavif -DENABLE_SHARED=OFF -DENABLE_STATIC=ON -DWITH_TURBOJPEG=OFF -DWITH_CRT_DLL=ON
cmake --build libjpeg-turbo/build.libavif --config Release --parallel
copy libjpeg-turbo\build.libavif\Release\jpeg-static.lib libjpeg-turbo\build.libavif\jpeg-static.lib
